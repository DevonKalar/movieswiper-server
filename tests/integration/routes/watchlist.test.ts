...
describe('Watchlist Integration Tests', () => {
    ...
    describe('GET /watchlist', () => {
        it('should return empty watchlist for authenticated user', async () => {
            const response = await request(app).get('/api/watchlist').set('X-User-ID', userId);
    ...
    describe('POST /watchlist', () => {
        ...
        it('should return 401 for unauthenticated user', async () => {
            const response = await request(app).post('/api/watchlist').send(testMovieData);
    ...
    describe('DELETE /watchlist/:id', () => {
        ...
        it('should return 404 when removing non-existent movie', async () => {
            ...
            expect(response.body).toHaveProperty('message', 'Watchlist item not found');
        });
